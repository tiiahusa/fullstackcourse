...
describe('Bloglist', () => {
    ...
    describe('when logged in', () => {
        ...
        test('a new blog can be created', async ({ page }) => {
          await createBlog(page, 'the first blog title', 'blog author', 'http://blogurl.com')
        ...
        describe('and several notes exists', () => {
            beforeEach(async ({ page }) => {
                await createBlog(page, 'the first blog title', 'blog author', 'http://blogurl.com')
                await createBlog(page, 'the second blog title', 'blogger', 'http://blog2url.com')
                await createBlog(page, 'the third blog title', 'writer', 'http://writesblog.com')
            })
        
            test('one of those can like', async ({ page }) => {
              const secondElement = await page.getByText('the second blog title').locator('..') 
