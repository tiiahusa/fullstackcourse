...
usersRouter.get('/', async (request, response) => {
  const users = await User
    .find({}).populate('notes', { content: 1, important: 1 }) // Populate hakee notejen kaikki tiedot ID:n perusteella vastaukseen ja voidana myös määrätä mitä kenttiä otetaan mukaan
