...
loginRouter.post('/', async (request, response) => {
  ...
  const passwordCorrect = user === null //Jos löytyy, tarkistetaan salasanan oikeellisuus
    ? false
  ...
  if (!(user && passwordCorrect)) {  //Jos käyttäjää ei ole olemassa tai salasana on väärä, vastataan statuskoodilla 401
